...
function CarDetailsPage({ favorites, toggleFavorite, carsData }) {
  ...
  // Check if this particular car is in the favorites array
      ...
      <div className="content-container">
        ...
        <div className="left-section">
          <div className="main-box">
            ...
            <img 
              src={`../assets/images/${car.images[0]}`} 
              alt={car.name} 
          ...
          <div className="small-box-container">
            <div className='firstbox'>
              <div className="small-box first">
                <img className='first' src={`../assets/images/${car.images[0]}`} alt={car.name} />
              </div>
            </div>
            <div className="small-box">
              <img src="../assets/images/View2.png" alt="Static 1" />
            </div>
            <div className="small-box">
              <img src="../assets/images/View3.png" alt="Static 2" />
            </div>
          </div>
        </div>
  ...
  <div className="stars">
    ...
    {/* 5th star as empty: fill="none" but keep stroke or fill a lighter color */}
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16" fill="none" stroke="#FBAD39">
      <path fillRule="evenodd" clipRule="evenodd" d="M8.16664 0.658349C8.2242 0.475814 8.33846 0.316382 8.49281 0.20321C8.64717 0.0900392 8.83358 0.0290222 9.02498 0.0290222C9.21637 0.0290222 9.40279 0.0900392 9.55714 0.20321C9.71149 0.316382 9.82575 0.475814 9.88331 0.658349L11.4333 5.42502H16.4333C16.6315 5.41752 16.8268 5.47513 16.9892 5.58905C17.1516 5.70296 17.2723 5.86692 17.3327 6.05586C17.3932 6.24481 17.3902 6.44835 17.324 6.63539C17.2579 6.82244 17.1324 6.9827 16.9666 7.09168L12.9083 10.0333L14.4583 14.8083C14.5196 14.9902 14.5212 15.187 14.4627 15.3698C14.4043 15.5526 14.2889 15.712 14.1335 15.8246C13.9781 15.9372 13.7907 15.9972 13.5988 15.9958C13.4068 15.9943 13.2204 15.9316 13.0666 15.8167L8.99998 12.8417L4.94164 15.7917C4.7879 15.9066 4.60145 15.9693 4.40951 15.9708C4.21758 15.9722 4.03022 15.9122 3.87479 15.7996C3.71936 15.687 3.604 15.5276 3.54557 15.3448C3.48713 15.162 3.48868 14.9652 3.54998 14.7833L5.09998 10.0083L1.04164 7.06668C0.875879 6.9577 0.750352 6.79744 0.684243 6.61039C0.618134 6.42335 0.615077 6.21981 0.675539 6.03086C0.736001 5.84192 0.856658 5.67796 1.01907 5.56405C1.18149 5.45013 1.37673 5.39252 1.57498 5.40002H6.57498L8.16664 0.658349Z"/>
    </svg>
  </div>
  <span className="reviews">440 Reviews</span>
</div>
  ...
  <div className="price-sectiondet">
    ${car.pricePerDay.toFixed(2)}/days
  </div>
